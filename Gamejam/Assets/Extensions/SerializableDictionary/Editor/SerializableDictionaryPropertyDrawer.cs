...
namespace LifelongAdventure.Helpers.SerializableDictionary.Editor
{
    ...
    public class SerializableDictionaryPropertyDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (property.isExpanded)
            {
                ...
                if ((keyArrayProperty.arrayElementType.Equals("string")))
                {
                    var filterTextPosition = position;
                    filterTextPosition.height = EditorGUIUtility.singleLineHeight;
                    filterTextPosition.y += EditorGUIUtility.singleLineHeight;
                    position.y += EditorGUIUtility.singleLineHeight;
                    position.yMax += EditorGUIUtility.singleLineHeight;
                    stringFilter = EditorGUI.TextField(filterTextPosition, "Key filter", stringFilter);
                    anyFilter = true;
                }
               
                if (valueArrayProperty.arrayElementType.Equals("PPtr<$Object>"))
                {
                    var filterObjPosition = position;
                    filterObjPosition.height = EditorGUIUtility.singleLineHeight;
                    filterObjPosition.y += EditorGUIUtility.singleLineHeight;
                    position.y += EditorGUIUtility.singleLineHeight;
                    position.yMax += EditorGUIUtility.singleLineHeight;
                    objFilter = EditorGUI.ObjectField(filterObjPosition, "Value filter", objFilter, typeof(Object), false);
                    anyFilter = true;
                }
                ...
                foreach(var entry in EnumerateEntries(keyArrayProperty, valueArrayProperty))
                {
                    ...
                    if (!string.IsNullOrEmpty(stringFilter))
                    {
                        try
                        {
                            if (keyProperty.stringValue.ToLower() != stringFilter.ToLower())
                                continue;
                        }
                        catch
                        { 
                    ...
                    if (objFilter != null)
                    {
                        try
                        {
                            if (valueProperty.objectReferenceValue != objFilter)
                                continue;
                        }
                        catch
                        {
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            if (property.isExpanded)
            {
                ...
                bool anyProp = false;
                if ((keysProperty.arrayElementType.Equals("string")))
                {
                    propertyHeight += EditorGUIUtility.singleLineHeight;
                    anyProp = true;
                }

                if (valuesProperty.arrayElementType.Equals("PPtr<$Object>"))
                {
                    propertyHeight += EditorGUIUtility.singleLineHeight;
                    anyProp = true;
                }
